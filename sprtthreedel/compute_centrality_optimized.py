...
def compute_centrality_measures_optimized(
    ...
    measures : list of str, optional
        ...
        Options: 'degree', 'degree_centrality', 'betweenness', 'closeness', 'eigenvector', 'pagerank', 'clustering'
    parallel : bool
    ...
    independent_measures = ['degree_centrality', 'clustering', 'eigenvector', 'pagerank']
